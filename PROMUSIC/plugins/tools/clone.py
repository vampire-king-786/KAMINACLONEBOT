...
C_BOT_COMMANDS = [
                ...
                {"command": "/tagall", "description": "ᴛᴀɢ ᴀʟʟ ᴍᴇᴍʙᴇʀ ᴛᴏ ᴀᴄᴛɪᴠᴇ ɢʀᴏᴜᴘ."}
                {"command": "/stoptagall", "description": "ᴛᴀɢ ᴀʟʟ ꜱᴛᴏᴘ."}
                {"command": "/vctag", "description": "ᴠᴄ ᴛᴀɢ ᴛᴏ ɪɴᴠɪᴛᴇ ᴛᴏ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ."}
                {"command": "/stopvctag", "description": "ꜱᴛᴏᴘ ᴠᴄ ᴛᴀɢ ."}
